...
const { insertDB, getDB, saveDB } = await import("../src/services/dbService.js");
const { newNote, getAllNotes, removeNote } = await import("../src/controllers/notesController.js");
